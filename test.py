...
version_label = tk.Label(root, text="Latest Versions:\nANDROID: 4.543.3\nIOS: 5.323.2", font=("Arial", 10, "bold"))
...
remove_label = tk.Label(root, text="Remove Old Version")
...
remove_entry.insert(0, last_app)  # Устанавливаем текст по умолчанию
...
add_label = tk.Label(root, text="Add New Version")
...
add_entry.insert(0, last_app)  # Устанавливаем текст по умолчанию
