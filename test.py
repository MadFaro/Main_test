...
tab_4 AS (
    SELECT 
        event_date,
        event_type_id,
        total_time_spent_seconds / event_count AS avg_time_spent_seconds
    FROM tab_2
)
SELECT 
    a.event_date, 
    a.event_type_id,
    a.call_count, 
    TO_CHAR(TRUNC(b.total_time_spent_seconds/86400) + MOD(b.total_time_spent_seconds, 86400) / 86400, 'HH24:MI:SS') AS total_time_spent,
    TO_CHAR(TRUNC(d.avg_time_spent_seconds/86400) + MOD(d.avg_time_spent_seconds, 86400) / 86400, 'HH24:MI:SS') AS avg_time_spent
FROM tab_3 a
