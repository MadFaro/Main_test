...
async def main_menu(sdep, tab, fio, id):
    ...
    put_row([
    put_column([
        put_column(rows_grid).style("width:100%;height:50%;transform:translateY(-5px);border-color:white;justify-content:center;display:grid;margin-top: 1.25rem;")
       ], size='auto')]
    ...
    put_html(f"""
       ...
       """).style("position:absolute;width:100%;bottom:0px;margin-top: 1.25rem;")
