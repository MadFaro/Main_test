...
def remove_stopwords(tokens):
    stop_words = set(stopwords.words('russian'))  # Подставьте язык вашего текста
...
# Применение предварительной обработки к каждому сообщению
...
# Применение предварительной обработки ко всему корпусу текста
