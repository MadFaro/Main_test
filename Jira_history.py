...
def monitor_folder(model, folder_path, text_file, results_list):
    while True:
...
if __name__ == "__main__":
    ...
    process1 = Process(target=monitor_folder, args=(model, folder1, file1, results_list1))
    process2 = Process(target=monitor_folder, args=(model, folder2, file2, results_list2))
    process3 = Process(target=monitor_folder, args=(model, folder3, file3, results_list3))
