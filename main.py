...
#    img_ban = open('img/ban.jpg', 'rb').read()
    ...
    if sdep == 'admin':
        ...
        put_row([
            None,
            put_text('\U0001F69B что то напишем интересное').style('margin-top: 0.8em;'),
            None,
        ...
        put_image("https://cdn.uralsib.ru/front/static/img/merch/banner.jpg", width='auto', height='auto').style('width:100%')
    put_row([
    put_column([
        put_tabs([
...
if __name__ == '__main__':
    start_server(main, host = '0.0.0.0', port = 8080, cdn=False)